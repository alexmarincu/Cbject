...
void test_cbject_Node_init(void) {
    ...
    cbject_Node * node = cbject_Node_init(cbject_stackAlloc(cbject_Node), object);
    TEST_ASSERT(cbject_isOfType(node, cbject_Node));
...
void test_cbject_Node_setters(void) {
    cbject_Node * node = cbject_Node_init(cbject_stackAlloc(cbject_Node), NULL);
    cbject_Node * previousNode = cbject_Node_init(cbject_stackAlloc(cbject_Node), NULL);
    cbject_Node * nextNode = cbject_Node_init(cbject_stackAlloc(cbject_Node), NULL);
    TEST_ASSERT(cbject_Node_getPrevious(node) == NULL);
