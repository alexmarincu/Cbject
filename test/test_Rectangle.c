...
static void checkRectanglePropsAccessors(Rectangle * const r);
...
{
    Rectangle * r = Rectangle_new(&(RectangleParams){{4, 5}, 1, 2});
...
{
    Rectangle * r = Rectangle_get(&(RectangleParams){{4, 5}, 1, 2});
    checkRectangleInit(r);
    checkRectanglePropsAccessors(r);
}
