...
void test_Rectangle_init(void) {
    ...
    TEST_ASSERT_EQUAL_UINT8(2 * 3, Shape_area(objectIn_(r, Rectangle, Shape)));
    dealloc_(r);
}
...
void test_Rectangle_setters(void) {
    ...
    TEST_ASSERT_EQUAL_UINT8(4 * 5, Shape_area(objectIn_(r, Rectangle, Shape)));
    dealloc_(r);
}
...
void test_Rectangle_makeSquare(void) {
    ...
    TEST_ASSERT_EQUAL_UINT8(4 * 4, Shape_area(objectIn_(r, Rectangle, Shape)));
    dealloc_(r);
}