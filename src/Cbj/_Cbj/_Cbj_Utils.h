...
#define _Cbj_Utils_feN
#define _Cbj_Utils_fe0(macro)
...
#define _Cbj_Utils_forEach(macro, ...)                                                                                                                                            \
    _Cbj_Utils_getArgN(                                                                                                                                                           \
        _Cbj_Utils_feN, ##__VA_ARGS__,                                                                                                                                            \
        _Cbj_Utils_fe30, _Cbj_Utils_fe29, _Cbj_Utils_fe28, _Cbj_Utils_fe27, _Cbj_Utils_fe26, _Cbj_Utils_fe25, _Cbj_Utils_fe24, _Cbj_Utils_fe23, _Cbj_Utils_fe22, _Cbj_Utils_fe21, \
        _Cbj_Utils_fe20, _Cbj_Utils_fe19, _Cbj_Utils_fe18, _Cbj_Utils_fe17, _Cbj_Utils_fe16, _Cbj_Utils_fe15, _Cbj_Utils_fe14, _Cbj_Utils_fe13, _Cbj_Utils_fe12, _Cbj_Utils_fe11, \
        _Cbj_Utils_fe10, _Cbj_Utils_fe9, _Cbj_Utils_fe8, _Cbj_Utils_fe7, _Cbj_Utils_fe6, _Cbj_Utils_fe5, _Cbj_Utils_fe4, _Cbj_Utils_fe3, _Cbj_Utils_fe2, _Cbj_Utils_fe1, _Cbj_Utils_fe0)(macro, ##__VA_ARGS__)
