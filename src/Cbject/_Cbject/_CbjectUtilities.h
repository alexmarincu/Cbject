...
#define _CbjectUtilities_stripParentheses(arguments) \
    _CbjectUtilities_stripParentheses_(_CbjectUtilities_stripParentheses__ arguments)
// #define _CbjectUtilities_stripParentheses(arguments) \
//     _CbjectUtilities_stripParentheses__ arguments
