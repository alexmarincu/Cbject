...
#define Cbject_AccessorFun_Setter_Prototype_x(typeName, fieldType, fieldName) \
...
#define Cbject_AccessorFun_Setter_Prototype(typeName, fieldType, fieldName) \
    Cbject_AccessorFun_Setter_Prototype_x(typeName, fieldType, fieldName)
...
#define Cbject_AccessorFun_Getter_Prototype_x(typeName, fieldType, fieldName) \
...
#define Cbject_AccessorFun_Getter_Prototype(typeName, fieldType, fieldName) \
    Cbject_AccessorFun_Getter_Prototype_x(typeName, fieldType, fieldName)
