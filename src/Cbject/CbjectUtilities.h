...
#define CbjectUtilities_vaArgs_(...) , ##__VA_ARGS__
#define CbjectUtilities_vaArgs(...) CbjectUtilities_vaArgs_(__VA_ARGS__)

#define CbjectUtilities_stripParentheses__(...) __VA_ARGS__
#define CbjectUtilities_stripParentheses_(x) x
#define CbjectUtilities_stripParentheses(arguments) CbjectUtilities_stripParentheses_(CbjectUtilities_stripParentheses__ arguments)
...
#define CbjectUtilities_forEach(macro, ...)                                                                             \
    CbjectUtilities_getArgN(                                                                                            \
        ...
        CbjectUtilities_fe10, CbjectUtilities_fe9, CbjectUtilities_fe8, CbjectUtilities_fe7, CbjectUtilities_fe6, CbjectUtilities_fe5, CbjectUtilities_fe4, CbjectUtilities_fe3, CbjectUtilities_fe2, CbjectUtilities_fe1)(macro, __VA_ARGS__)
