...
#define Cbject_VirtFunPtr_x1(className, funReturnType, funName, case, ...) \
    Cbject_VirtFunPtr_case##case (className, funReturnType, funName, __VA_ARGS__)

#define Cbject_VirtFunPtr_x0(className, funReturnType, funName, ...) \
    Cbject_VirtFunPtr_x1(className, funReturnType, funName, __VA_ARGS__)

#define Cbject_VirtFunPtr(funReturnType, funName, funParams) \
    Cbject_VirtFunPtr_x0(Type, funReturnType, funName, Cbject_Utils_unpack(funParams))
